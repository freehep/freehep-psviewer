...
public class GraphicsStateOperator extends PSOperator {
    ...
    public static Class[] operators = {
        GSave.class, GRestore.class, ClipSave.class, ClipRestore.class,
        GRestoreAll.class, InitGraphics.class, 
        GState.class, SetGState.class, CurrentGState.class,
        SetLineWidth.class, CurrentLineWidth.class,
        SetLineCap.class, CurrentLineCap.class,
        SetLineJoin.class, CurrentLineJoin.class,
        SetMiterLimit.class, CurrentMiterLimit.class,
        SetStrokeAdjust.class, CurrentStrokeAdjust.class,
        SetDash.class, CurrentDash.class,
        SetColorSpace.class, CurrentColorSpace.class,
        SetColor.class, CurrentColor.class,
        SetGray.class, CurrentGray.class,
        SetHSBColor.class, CurrentHSBColor.class,
        SetRGBColor.class, CurrentRGBColor.class,
        SetCMYKColor.class, CurrentCMYKColor.class
    };
...
class SetHSBColor extends GraphicsStateOperator {
    { operandTypes = new Class[] {PSNumber.class, PSNumber.class, PSNumber.class}; }
    ...
    public boolean execute(OperandStack os) {
        ...
        Color color = new Color(Color.HSBtoRGB(h.getFloat(), s.getFloat(), b.getFloat()));
...
class CurrentHSBColor extends GraphicsStateOperator {
    ...
    public boolean execute(OperandStack os) {
        ...
        float[] hsb = Color.RGBtoHSB((int)(color[0]*255), (int)(color[1]*255), (int)(color[2]*255), null);
...
class SetCMYKColor extends GraphicsStateOperator {
    { operandTypes = new Class[] {PSNumber.class, PSNumber.class, PSNumber.class, PSNumber.class}; }
...
class CurrentCMYKColor extends GraphicsStateOperator {
    ...
    public boolean execute(OperandStack os) {
        ...
        if (bg < 0) {
            bg  = ((PSNumber)os.popNumber()).getFloat();
        ...
        ucr = ((PSNumber)os.popNumber()).getFloat();
