 ...
 * @version $Id: src/main/java/org/freehep/postscript/MatrixOperator.java 17245790f2a9 2006/09/12 21:44:14 duns $
 */
public class MatrixOperator extends PSOperator {
        
    public static Class[] operators = {
        Matrix.class, InitMatrix.class, IdentMatrix.class,
        DefaultMatrix.class, CurrentMatrix.class, SetMatrix.class,
        Translate.class, Scale.class, Rotate.class,
    ...
    public boolean execute(OperandStack os) {
        if (os.checkType(PSNumber.class, PSNumber.class)) {
            ...
            if (a.size() >= 6) {
                ...
                a.set(0, sx); a.set(1, 0);
                a.set(2, 0);  a.set(3, sy);
                a.set(4, 0);  a.set(5, 0);
                os.push(a); 
            } else {
                error(os, new RangeCheck());
    ...
    public boolean execute(OperandStack os) {
        if (os.checkType(PSNumber.class)) {
            ...
            if (a.size() >= 6) {
                ...
                a.set(0, cosTheta);  a.set(1, sinTheta);
                a.set(2, -sinTheta); a.set(3, cosTheta);
                a.set(4, 0);         a.set(5, 0);
                os.push(a); 
            } else {
                error(os, new RangeCheck());
...
class ITransform extends MatrixOperator {
    ...
    public boolean execute(OperandStack os) {
        ...
        try {
            Point2D d = transform.inverseTransform(new Point2D.Double(dx, dy), null);
            os.push(d.getX());
            os.push(d.getY());
