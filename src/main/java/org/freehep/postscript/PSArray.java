 ...
 * @version $Id: src/main/java/org/freehep/postscript/PSArray.java 17245790f2a9 2006/09/12 21:44:14 duns $
 */
public class PSArray extends PSPackedArray {
    ...
    public PSArray subArray(int index, int count) {
        if ((index < 0) || (index+count) > length) {
            throw new IllegalArgumentException("Trying to create subArray("+index+", "+count+") with length="+length+".");
        }        
