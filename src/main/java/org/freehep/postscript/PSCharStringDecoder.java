...
public class PSCharStringDecoder {
	...
	do {
		...
		if (byte1 != 12) {
		    switch (byte1) {
		    case 14: addCommand("eofill"); break;
		    case 13: hsbw(); break;
		    case  9: addCommand("closepath"); break;
		    case  6: addCommand("hlineto"); break;
		    case 22: addCommand("hmoveto"); break;
		    case 31: addCommand("hcurveto"); break;
		    case  5: addCommand("rlineto"); break;
		    case 21: addCommand("rmoveto"); break;
		    case  8: addCommand("rrcurveto"); break;
		    case 30: addCommand("vhcurveto"); break;
		    case  7: addCommand("vlineto"); break;
		    case  4: addCommand("vmoveto"); break;
		    case  1: ignore(2); break; // hstem
		    case  3: ignore(2); break; // vstem
		    default: System.err.println("Command "+byte1+" not implemented"); break;
		    }		    
		} else {
		    int byte2 = decryption.read();
		    switch (byte2) {			
		    case  7: sbw(); break;
		    case  0: ignore(2); break; // dotsection
		    case  2: ignore(6); break; // hstem3
		    case  1: ignore(6); break; // vstem3
		    case  33: addCommand("setcurrentpoint"); break; // vstem3
		    default: System.err.println("Command 12 "+byte2+" not implemented"); break;
		    }
		}
	    } else {
